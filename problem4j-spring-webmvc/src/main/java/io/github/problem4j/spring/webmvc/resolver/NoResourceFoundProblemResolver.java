...
public class NoResourceFoundProblemResolver extends AbstractProblemResolver {
  ...
  /**
   * Returns a {@link Problem} with {@code 404 Not Found} indicating the requested static resource
   * could not be located. Other parameters ({@code context}, {@code headers}, {@code status}) are
   * ignored because the exception semantics unambiguously map to 404.
   *
