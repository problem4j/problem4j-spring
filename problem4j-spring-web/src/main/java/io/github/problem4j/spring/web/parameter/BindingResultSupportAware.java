 ...
 * ProblemBeanPostProcessor} and configured with the container's {@link BindingResultSupport} bean.
 *
 * @see BindingResultSupport
 * @since 3.1.0
 */
public interface BindingResultSupportAware extends ProblemSupportAware {
